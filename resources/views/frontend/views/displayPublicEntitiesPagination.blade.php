...
<div id="demo" class="box jplist grid">
   ...
   <div class="panel box panel-top">
    ...
    <select
       class="select pull-left selectpicker" 
       data-control-type="select" 
       data-control-name="paging" 
       data-control-action="paging">
         
        <option data-number="8" data-default="true"> 8 per page </option>
        <option data-number="12"> 12 per page </option>
        <option data-number="16" > 16 per page </option>
      ...
      <div class="list-item box">
         ...
         <!-- profile image -->
            <a class="img" href="{!! $profile['url'].'/'.$session_id !!}">
              <img src="{!!$profile['file_link']!!}" alt="" title=""  style="width:300px;"  class="img-thumbnail" >
            </a>
   ...
   <div class="panel box panel-top">
        ...
        <div 
           class="paging-results pull-right" 
