...
<h1><small><a href="{!!URL::to('admin/settings')!!}"><span class="glyphicon glyphicon-arrow-down"></span> {!!Client::find(Session::get('client_id'))->organization!!} Settings </a></small></h1>
<h2>{!!$settings['name']!!} <small><span class="glyphicon glyphicon-pencil"></span> Edit Settings</small></h2>
		...
		<div id="panel-bsbutton" class="panel panel-default magic-element width-full">
		    <div class="panel-heading">
		        ...
		        <div class="panel-actions">
		                <span class="label label-success">{!!$settings['name']!!}</span>
		        </div>
		        <h3 class="panel-title">Edit {!!$settings['name']!!}</h3>
		    </div><!-- /panel-heading -->
		    <div class="panel-body">

		<div class="row">
				{!! Form::model($settings,array('class'=>'form-horizontal','role'=>'form')) !!}
					...
					<div class="col-sm-2">
						...
						<div class="col-sm-10">
							<div class="radio">
								<label>
									{!! Form::radio('program_type', 'contribution','', array('disabled'=>'disabled')) !!}
									Contribution - This requires sponsorship contributions to reach a certain threshold to complete sponsorship.
								</label>
							</div>
							<div class="radio">
								<label>
									{!! Form::radio('program_type', 'number','', array('disabled'=>'disabled')) !!}
									Number of Sponsors - This requires a certain number of sponsors to complete sponsorship.
								</label>
							</div>
							<div class="radio">
								<label>
									{!! Form::radio('program_type', 'funding','', array('disabled'=>'disabled')) !!}
									Funding - This requires a certain amount of total donations to complete sponsorship.
								</label>
							</div>
							<!-- <div class="radio">
								<label>
									{!! Form::radio('program_type', 'one_time','', array('disabled'=>'disabled')) !!}
									One-Time - Defaults to One-Time donation, with an option of giving monthly. Sponsorships don't complete.
								</label>
							</div>
					...
					@elseif ($settings['program_type'] == 'number')
					...
					@elseif ($settings['program_type'] == 'funding')
						<div class="form-group">
					...
					@if ($settings['program_type'] == 'one_time')

						<div class="form-group">
							{!! Form::label('sponsorship_amount', 'One-Time Donation Amount(s)',array('class'=>'col-sm-2 control-label')) !!} <!-- <span class="label label-primary required">Required</span> -->
							<div class="col-sm-10">
							<br/>
								<div class="input-group">
		                        ...
		                        <br/>
					              	<div class="alert alert-info alert-icon">
					                	 <div class="icon"><i class="glyphicon glyphicon-question-sign"></i></div>
					                       <strong>About One-Time Donation Amount(s) : </strong><br/> 
					                       This is what the Donor pays for a One-Time donation.<br/> 
					                       This can be a single fixed value, a dropdown list, or a blank input box.<br/>
					                       <ul>
						                       <li> For a single fixed value just type in one number.</li>
						                       <li> For a dropdown with multiple amounts separate the amounts with commas.</li> 
					...
					@else
						<div class="form-group">
							{!! Form::label('sponsorship_amount', 'Sponsorship Amount(s)',array('class'=>'col-sm-2 control-label')) !!} <!-- <span class="label label-primary required">Required</span> -->
							<div class="col-sm-10">
							<br/>
								<div class="input-group">
									{!! Form::text('sponsorship_amount', $value = null, $attributes = array('placeholder'=>'Enter like this: "10" or "10,25,50" or just leave it blank','class' => 'form-control')) !!}
